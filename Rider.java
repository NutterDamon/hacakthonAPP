public class Rider {
    ...
    int time_return;
    String day;
    double driver_distance_preference;
    boolean is_driver;
    ...
    public void set_driver_distance_preference(double driver_distance_preference) {
    ...
    public double get_driver_distance_preference(){
    ...
    public void print() {
        ...
        System.out.println("Time of Return: " + time_return);
