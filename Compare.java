...
public class Compare {
    ...
    double distance_between_addresses;

    Compare(Rider rider_to_compare, ArrayList<Rider> riders){
        this.rider_to_compare = rider_to_compare;
        this.riders = riders;
    }
    public double get_distance_between_addresses(){
        return distance_between_addresses;
    }
    public void set_distance_between_addresses(double distance_between_addresses){
    ...
    public String find_match() throws Exception{
    ...
    public double compare_address(Rider r1, Rider r2) throws Exception{
